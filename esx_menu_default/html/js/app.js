(function(){
	let MenuTpl =
		...
		'<div class="shake">'+
			'<div class="head">'+
			'<img src="https://cdn.discordapp.com/attachments/1018972901497651393/1024453272024662087/REDISENO-LOGO-LAFAMA-RP-OK-javo-PNG.png" class="logo">'+
			'<div class="headtitle">{{{title}}}</div></div>' +
		/**'<div class="headtitle">Server Name</div></div>' +**/

				'<div class="menu-items">' + 
							'{{#elements}}' +
							'<div class="menu-item {{#selected}}selected{{/selected}}">' +
							/**'<span id="icon" class="fa fa-bars"> </span>'+**/
							/**'<span id="icon" class="fa fa-bars"> </span>{{{label}}}{{#isSlider}} : &lt;{{{sliderLabel}}}&gt;{{/isSlider}}'+**/
							'<span id="icon" class="fa fa-bars"> </span> {{#showImage}}{{/showImage}}{{{label}}}{{#isSlider}}   <span style="color:skyblue">[{{{sliderLabel}}}]</span>{{/isSlider}}'+
							'</div>' +
						'{{/elements}}' +
						'</div>'+
					'</div>' +
